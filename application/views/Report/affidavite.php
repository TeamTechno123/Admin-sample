...
<html lang="en" dir="ltr">
  ...
  <!-- <body> -->
    ...
    <div class="" style="padding:10px 40px; ">
      ...
      <p style="font-size:12px; line-height: 16px; margin: 0px; text-align:center; ">And</p>
      <p style="font-size:12px; line-height: 24px; margin: 0px; text-align:center; ">IN THE MATTER OF APPLICATION –  <b>  <?php echo $ORGANIZATION; ?><?php echo $NAME; ?></b></p>
      <p style="font-size:12px; line-height: 16px; text-align:justify; ">I, <?php echo $single_name[0]; ?>, aged <?php echo $AGE; ?> years, Citizen of India residing <?php echo $FIRMADDRESS; ?>. do hereby solemnly and sincerely declare and state as follows: </p>
    </div>
      <br><br><br><br> <br><br>
    ...
    <?php if(isset($organization_id) && ($organization_id == 1)){ //Applicant ?>
      ...
      <p style="font-size:12px; text-align:justify; ">2. I have been engaged As <b><?php echo $SERVICES; ?></b> (hereinafter reffered to as "said goods / Services"), which are marketed under the Trade Mark "<b><?php echo $BRAND; ?></b>"  </p>
    ...
    <?php } elseif (isset($organization_id) && ($organization_id == 3 || $organization_id == 5)) {
      ...
      <p style="font-size:12px; text-align:justify; ">2. My concern is engaged as of <b><?php echo $SERVICES; ?></b> (hereinafter referred to as “said goods / Services”), which are marketed under the said Trade Mark “<b><?php echo $BRAND; ?></b>”.</p>
    ...
    <?php } elseif (isset($organization_id) && ($organization_id == 4 || $organization_id == 7 || $organization_id == 10)) {
      ...
      <p style="font-size:12px; text-align:justify; "> &nbsp;&nbsp;&nbsp; I am authorized and competent to make this affidavit. The statements made here in under are partly based on my personal knowledge, partly on information derived by me from the records of my concern to which I have full access and which I believe to be true, and partly these are my submissions. </p>
      <p style="font-size:12px; text-align:justify; ">2. Our Firm is engaged as <b><?php echo $SERVICES; ?></b> (hereinafter referred to as “said goods / Services"), which are marketed under the said Trade Mark “<b><?php echo $BRAND; ?></b>”.</p>
      <p style="font-size:12px; text-align:justify; ">3. The said Trade Mark <b><?php echo $BRAND; ?></b> has been used in India continuously since <b><?php echo $PROPOSED; ?></b> in connection with the said goods and by reason of such use the said services bearing the Trade Mark <b><?php echo $BRAND; ?></b> have come to be understood as being
      <b><?php if(isset($TRADE)){ echo $TRADE; } ?></b> by my concern.</p>
    ...
    <?php }?>
      ...
      <p style="font-size:12px; text-align:justify; ">4.	Sales of the said goods / Services in India by my concern have been considerable and I give details thereof:  </p>
      ...
      <p style="font-size:12px; text-align:justify; ">5.	I have spent approximately on account of advertising as follows. </p>
      <table>
        <style media="print">
        table {
          border-collapse: collapse;
      ...
      <p style="font-size:12px; text-align:justify; ">6. Annexed hereto and collectively marked Exhibit A-1, are a bunch of invoices showing that  goods / Services bearing Trade Mark have been supplied to various clients and Exhibit A-2 has the copies of advertisement material in respect of the above trademark.</p>
      
      <p style="font-size:12px; text-align:justify; ">7. Our Firms said goods / Services are of high standard and by reason of such and by the use of Trade Mark in relation to said goods / Services the Trade Mark denotes to those trades a distinctive symbol of the <?php if(isset($TRADE)){ echo $TRADE; } ?> by my concern. I believe that my concern is entitled to the registration of the Trade Mark in respect of the said goods / Services, the subject of this application.
      ...
      <div class="" style="padding:10px 30px; ">
        ...
        $year = date('Y',$af_date);
         ?>
        <p style="font-size:12px; text-align:justify;">The statements made in paragraph 1, 2, & 3 are true to our knowledge, and the extracts in paragraph 4 & 5 are according to the available records of our concern, and those of 7 are my submissions to the Learned Registrar.</p>
        ...
        <p style="font-size:12px; text-align:justify;">SIGNED, SEALED AND DELIVERED this ___ day of _____  by the said (Deponent)</p>
        ...
        <p style="font-size:12px;  "> <span style="text-align:left;">NOTARY PUBLIC</span>  <span style="float:right;"><b> For <?php echo $ORGANIZATION; ?> <?php } ?></b>
        </span>    </p><br><br>
        

        <p style="font-size:12px;  "> <span style="text-align:left;"></span>  <span style="float:right;">________________________________ </span>    </p>
        <br>
          <p style="font-size:12px; text-align:right;  font-weight:bold; text-transform: uppercase;"> <?php echo $single_name[0]; ?></p>
